---
name: iblai-add-component
description: Generic guide for adding any IBL.ai SDK component from @iblai/iblai-js/web-containers to a page, including discovery via MCP tools, import patterns, and the standard page boilerplate
---
