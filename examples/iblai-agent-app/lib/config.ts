 ...
 *      single origin (e.g. https://api.iblai.org). LMS, DM, and AXD
...
const domain = () =>
  getEnv("NEXT_PUBLIC_PLATFORM_BASE_DOMAIN", "iblai.org");
...
export const config = {
  ...
  mainTenantKey: () => getEnv("NEXT_PUBLIC_MAIN_TENANT_KEY", "iblai"),
  platform: () => getEnv("NEXT_PUBLIC_IBL_PLATFORM", "agent"),
  defaultAgentId: () => getEnv("NEXT_PUBLIC_DEFAULT_AGENT_ID", "00000000-0000-0000-0000-000000000000"),
