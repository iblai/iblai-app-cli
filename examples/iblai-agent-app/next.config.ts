...
/**
 * Resolve a package to its root directory so webpack/turbopack never loads
...
// Build resolve aliases once — shared by Turbopack and Webpack.
// Deduplicates packages that the SDK may pull in with different versions.
// Without this, RTK Query hooks inside SDK components silently return
// undefined because they use a different ReactReduxContext.
