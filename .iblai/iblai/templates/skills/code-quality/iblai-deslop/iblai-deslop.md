...
```
WebFetch https://raw.githubusercontent.com/iblai/iblai-app-cli/refs/heads/main/examples/iblai-agent-app/skills/iblai-deslop/references/checklist.md
WebFetch https://raw.githubusercontent.com/iblai/iblai-app-cli/refs/heads/main/examples/iblai-agent-app/skills/iblai-deslop/references/audit-format.md
```
...
```
WebFetch https://raw.githubusercontent.com/iblai/iblai-app-cli/refs/heads/main/examples/iblai-agent-app/skills/iblai-deslop/references/fix-playbook.md
```
...
- **Use scripts for mechanical scanning.** Download and run the helper scripts to accelerate Pass 1 findings:
  ```bash
  curl -sO https://raw.githubusercontent.com/iblai/iblai-app-cli/refs/heads/main/examples/iblai-agent-app/skills/iblai-deslop/scripts/scan_dead_code.sh
  curl -sO https://raw.githubusercontent.com/iblai/iblai-app-cli/refs/heads/main/examples/iblai-agent-app/skills/iblai-deslop/scripts/scan_patterns.sh
  curl -sO https://raw.githubusercontent.com/iblai/iblai-app-cli/refs/heads/main/examples/iblai-agent-app/skills/iblai-deslop/scripts/scan_dependencies.sh
