---
name: iblai-add-organization-page
description: Add a full-screen organization settings page using the SDK Account component with Organization, Management, Integrations, Advanced, and Billing tabs
---

# Add an Organization Settings Page
...
### 1. Create `app/(app)/organization/page.tsx`
