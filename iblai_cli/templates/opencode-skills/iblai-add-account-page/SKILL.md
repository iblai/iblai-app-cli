---
name: iblai-add-account-page
description: Add a full-screen account settings page using the SDK Account component with Organization, Management, Integrations, Advanced, and Billing tabs
---
