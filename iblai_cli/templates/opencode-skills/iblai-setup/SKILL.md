---
name: iblai-setup
description: IBL.ai app setup guide — what is already configured in a generated app, how auth data works, how to add new pages, run E2E tests, and use the MCP server
---
