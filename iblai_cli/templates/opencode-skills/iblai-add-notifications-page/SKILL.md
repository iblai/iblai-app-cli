---
name: iblai-add-notifications-page
description: Add a full-screen notification center with Inbox and Alerts tabs using the SDK NotificationDisplay component
---
